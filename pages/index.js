        ...
        <div className={styles.app_content}>
          <div className={stylesOnboarding.onboarding_container}>
            <div className={stylesOnboarding.onboarding_meta}>
              ...
              <h1 ref={headingRef} className={stylesOnboarding.onboarding_header}><span>Let's get</span> <span>you started</span></h1>
              <p ref={paragraphRef}>Let’s setup your username and authentication image to help you secure your [X] Wallet. They are unique to you and can help you recover your Seed Phrase later on.</p>
